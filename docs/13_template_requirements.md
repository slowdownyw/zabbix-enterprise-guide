---
title: "Требования к шаблонам мониторинга"
description: "Раздел фиксирует требования к шаблонам мониторинга Zabbix: структуру, именование, теги, discovery, триггеры и ограничения перед реализацией."
---
