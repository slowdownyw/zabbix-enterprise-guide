...
4. **Никакого нового инструментария.** Хочется поднять Netbox? Нельзя. Excel/Confluence/Bookstack — что уже есть
...
- ❌ **Рисовать топологию сети до последнего порта.** Вы не сетевик и вам её все равно даст сетевик за 30 минут. Вам нужен **логический** уровень: какие сегменты, как связаны, где границы.
