...
|---|---|
| Сетевые интерфейсы | `net.if.discovery` (Linux и Windows) |
...
- ❌ **Переписывать встроенные шаблоны Zabbix.** При апгрейде версии правки будут потеряны. Только клонировать.
