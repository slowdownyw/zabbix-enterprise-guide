---
title: "Runbook"
description: "Раздел показывает, каким должен быть runbook для эксплуатации Zabbix: коротким, проверяемым и пригодным для дежурной смены во время реального инцидента."
---
