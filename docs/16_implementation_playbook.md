---
title: "Руководство по внедрению: от дизайна к эксплуатации"
description: "Руководство описывает внедрение мониторинга как управляемый проект: роли, фазы, phase gates, артефакты и переход от дизайна к устойчивой эксплуатации."
---
...
В книге есть [90-дневная дорожная карта внедрения](07_implementation_roadmap.md). Её нельзя читать как обещание, что любой Zabbix-проект делается за 90 дней.
