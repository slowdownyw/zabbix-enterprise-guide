---
title: "Zabbix Enterprise Guide — зрелый мониторинг крупной инфраструктуры"
description: "Русскоязычная книга о построении зрелого мониторинга на Zabbix для крупной инфраструктуры: сервисная модель, severity, теги, LLD, runbooks, SLA и эксплуатация."
---

# Zabbix Enterprise Guide

## Практическое руководство по зрелому мониторингу крупной инфраструктуры

Книга о том, как строить зрелый мониторинг на Zabbix для крупной гетерогенной инфраструктуры: сервисная модель, severity, теги, LLD, runbooks, SLA, дашборды и эксплуатация.
...
1. [**Манифест**](00_manifesto.md) — зачем эта книга и кому она полезна
