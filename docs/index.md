---
title: "Zabbix Enterprise Guide — практическое руководство по зрелому мониторингу крупной инфраструктуры"
description: "Русскоязычная книга о построении зрелого мониторинга на Zabbix для крупной инфраструктуры: сервисная модель, severity, теги, LLD, runbooks, SLA, дашборды и эксплуатация."
---
