---
title: "Anti-patterns — что НЕ делать"
description: "Сводный раздел перечисляет анти-паттерны внедрения и эксплуатации Zabbix, которые создают шум, ломают ответственность и мешают зрелому мониторингу."
---
...
### ❌ Считать сырой Zabbix-export полноценным GitOps
