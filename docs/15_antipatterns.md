...
### ❌ Запускать nmap по всей инфре без ИБ
...
Prometheus прекрасен для cloud-native стека. Для legacy Windows-инфры с 1С, Exchange, SCADA и SNMP-периметра Zabbix объективно сильнее. Зрелость инструмента ≠ модность.
