...
| **Alert hygiene** | Регулярная дисциплина чистки шумных триггеров, проверки severity, покрытия runbook'ами и маршрутизации. | [Операционка](12_operations.md), [Дашборды](11_dashboards_reporting.md) |
...
| **Maintenance by tags** | Подавление конкретного типа проблем через теги. Окно обслуживания задаётся на hosts/host groups, а теги используются как фильтр подавления проблем внутри заданной области. | [Теги](03_tags_and_groups.md), [Операционка](12_operations.md) |
...
| **Linked template** | Шаблон, привязанный к host или другому template. В Zabbix композиция строится через набор связанных шаблонов. | [Многоуровневая модель](05_layered_design.md) |
...
| **NVPS** | New values per second: поток новых значений в Zabbix. Важен для оценки нагрузки server и БД. | [Roadmap](07_implementation_roadmap.md), [Implementation Playbook](16_implementation_playbook.md) |
...
| **PR/review** | Проверка изменений перед применением: шаблоны, схема тегов, действия уведомлений, дашборды, отчёты. | [GitOps](08_gitops_for_zabbix.md), [Implementation Playbook](16_implementation_playbook.md) |
...
| **MSSQL** | Частый слой middleware для 1С/Exchange/приложений: блокировки, взаимные блокировки, возраст резервной копии, tempdb, сессии. | [Требования к шаблонам](13_template_requirements.md), [Многоуровневая модель](05_layered_design.md) |
