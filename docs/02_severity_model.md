...
Понизьте severity, переведите в дашборд, удалите. Что угодно — кроме оставить как есть и продолжать делать вид, что у вас алерт Disaster.
...
> **Важно:** в Zabbix Information — это всё равно trigger severity, которая создаёт событие PROBLEM. Для аудитных целей иногда правильнее использовать audit log Zabbix, event stream или report, а не события PROBLEM: они захламляют ленту Problems и могут мешать дежурному видеть реальные инциденты.
...
## Как чистить завышение severity
...
- Завышение severity чистится **после** стандартизации шаблонов, не до
