...
**Практическое руководство по мониторингу крупного предприятия** — 1С, Exchange, MSSQL, SCADA, сетевое железо.
...
| Главы | Тема |
|-------|------|
| 1–5 | Принципы: сервис vs хост, severity, теги и группы, LLD, слоистый дизайн |
| 6–8 | Архитектура: развёртывание, Proxy Groups, 90-day roadmap, GitOps |
| 9–11 | Runbooks, SLA, дашборды |
| 12–15 | Шаблоны, антипаттерны, операционная рутина |
